...
public class ButtonController {
    ...
    public ResponseEntity<String> handleButtonClick(@RequestBody Map<String, Object> request) {
        try {
            ...
            System.out.println("=== 일반 버튼 클릭 이벤트 (hacked-backend) ===");
            System.out.println("버튼 타입: " + (buttonType != null ? buttonType : "알 수 없음"));
            if (nickname != null) {
                System.out.println("닉네임: " + nickname);
                System.out.println("시도횟수: " + attemptCounts.get(nickname));
            }
            
            // 전체 시도횟수 통계 출력
            System.out.println("--- 전체 시도횟수 통계 ---");
